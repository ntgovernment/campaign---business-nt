<footer class="ntg-footer" role="contentinfo">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<div class="ntg-footer__nav-cols-wrap">
					<div class="row">
						<div class="col-sm-6">
							<nav class="footer-vertical-nav" aria-label="footer">
								<h3 class="footer-vertical-nav__title">Contact us</h3>
								<ul>
									<li>
